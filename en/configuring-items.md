...
Polecenie `/economy backpack add <użytkownik> <przedmiot>` jest narzędziem administracyjnym, które pozwala autoryzowanym użytkownikom na dodawanie przedmiotów
...
Polecenie `/economy backpack remove <użytkownik> <przedmiot>` umożliwia autoryzowanym użytkownikom usuwanie przedmiotów bezpośrednio z plecaka użytkownika.
...
Polecenie `/economy backpack clear <użytkownik>` pozwala autoryzowanym użytkownikom na wyczyszczenie całego plecaka użytkownika, usuwając wszystkie
...
Jeśli chcesz, aby dochód z tego przedmiotu był rozdzielany między wielu właścicieli, możesz wybrać role lub indywidualnych użytkowników, którzy będą uważani za właścicieli.
użytkowników, którzy będą uważani za właścicieli. Dochód zostanie równomiernie rozdzielony między wybranych właścicieli.


### Wymagania dotyczące zakupu przedmiotu

Jeśli chcesz ustawić określone wymagania dla użytkowników, aby mogli zakupić element, możesz wybrać role lub
indywidualnych użytkowników, którzy muszą spełnić te wymagania. Użytkownicy, którzy nie spełnią wymagań, nie będą mogli kupić elementu.
elementu.
